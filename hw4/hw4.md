...
|-----------|-----------|--------|
| DataFrame API | PySpark SQL | 3.x |
| ML Алгоритмы | PySpark MLlib | 3.x |
| Кросс-валидация | ml.tuning.CrossValidator | 3.x |
| Оценка модели | ml.evaluation.RegressionEvaluator | 3.x |
