...
| Компонент | Библиотека | Функция |
|-----------|-----------|---------|
| Обработка данных | PySpark SQL | Агрегация, группировка |
| Геоанализ | GeoPandas | CRS, координаты |
| Геометрия | Shapely | Point, Polygon, расстояния |
| Картография | Folium | Интерактивные карты |
| Парсинг JSON | json | GeoJSON файлы |
